...
// OCSWITS Victims Data Processing
// Version 2, Date: 2024-11-26

clear all

// Importing dfVictims row data
import delimited D:\Professional\Projects-OCPW\OCTraffic\OCSWITRS\Analysis\dfVictims_final.csv, delimiter(comma) bindquote(strict) varnames(1) stripquote(yes)
...
save "D:\Professional\Projects-OCPW\OCTraffic\OCSWITRS\Analysis\stVictims.dta", replace
