...
// Importing dfParties row data
import delimited D:\Professional\Projects-OCPW\OCTraffic\OCSWITRS\Analysis\dfParties_final.csv, delimiter(comma) bindquote(strict) varnames(1) stripquote(yes)
label data "OCSWITRS Partiess Stata Dataset"

// Case ID variable operations
ren ïcase_id case_id
...
order crashes_indicator, after(party_number)
...
save "D:\Professional\Projects-OCPW\OCTraffic\OCSWITRS\Analysis\stParties.dta", replace
